...
export const JoinPage: React.FC = () => {
  ...
  return (
    <div ref={pageRef} className="join-page">
      {/* SECTION: HERO */}
      <section ref={heroRef} className="section-hero join-hero theme-black" style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', paddingTop: '120px' }}>
